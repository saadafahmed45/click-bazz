        ...
        <div className="row">
          <div className=" col-12 col-md-6">
            <div className="header-section">
              <h1>
                To Make Your <br />
                Creative <span className="brand-color">Photography</span>
              </h1>
              <p>
                ...
                things, long after you have forgotten everything.What I like
                about photographs is that they capture a moment that’s gone
                forever”
              </p>
